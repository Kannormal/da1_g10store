...
<body>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-center mb-4">
            <div class="btn-group">
                <a href="#" class="btn btn-dark bg-primary-dark-blue rounded-start">Ảnh sản phẩm</a>
                <a href="<?= ADMIN_URL . "?ctl=listpt_bv" ?>" class="btn btn-outline-dark button-not-dark-blue rounded-end">Ảnh bài viết</a>
            </div>
        </div>
        <a href="<?= ADMIN_URL . "?ctl=addpt_sp" ?>"
            ...
            <tbody>
                <?php foreach ($imageProducts as $imageProduct) : ?>
                    <tr>
                        ...
                        <td>
                            <img src="<?= ROOT_URL . $imageProduct['image_src'] ?>" width="60" alt="">
                        </td>
                        <td><?= $imageProduct['status'] ? 'Được Hiện' : 'Bị Ẩn' ?></td>

                        <td><?= $imageProduct['created_at'] ?></td>
                        <td><?= $imageProduct['updated_at'] ?></td>
                        <td>
                            <a href="<?= ADMIN_URL . '?ctl=editpt_sp&id=' . $imageProduct['ID'] ?>" class="btn btn-dark button-not-dark-blue">Cập nhật</a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
