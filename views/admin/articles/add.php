...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 content">
            <div class="forms">
                <h2>Thêm Bài viết</h2>
                <form action="<?= ADMIN_URL . '?ctl=storear' ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="name" id="" class="form-control" placeholder="Nhập tiêu đề bài viết ở đây">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="category_id" id="" class="form-control" placeholder="Nhập danh mục bài viết ở đây">
                    ...
                    <input type="submit" value="Thêm Bài viết ->" class="btn button-not-dark-blue ">
                </form>
            </div>
        </div>
    </div>
