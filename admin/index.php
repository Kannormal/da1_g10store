...
require_once __DIR__ . "/../controllers/admin/AdminImageProductController.php";
require_once __DIR__ . "/../controllers/admin/AdminImageArticleController.php";
...
match ($ctl) {
    ...
    'listpt_sp' => (new AdminImageProductController)->all(),
    'addpt_sp' => (new AdminImageProductController)->create(),
    'storept_sp' => (new AdminImageProductController)->store(),
    'editpt_sp' => (new AdminImageProductController)->edit(),
    'updatept_sp' => (new AdminImageProductController)->update(),
    ...
    'listpt_bv' => (new AdminImageArticleController)->all(),
    'addpt_bv' => (new AdminImageArticleController)->create(),
    'storept_bv' => (new AdminImageArticleController)->store(),
    'editpt_bv' => (new AdminImageArticleController)->edit(),
    'updatept_bv' => (new AdminImageArticleController)->update(),
